  ...
  return (
    <Wrap spacing="30px" justify="center" minHeight="100vh">
      {loading ? (
        ...
        <Alert status="error">
          <AlertIcon /> <AlertTitle>We are sorry!</AlertTitle> <AlertDescription>{error}</AlertDescription>{' '}
        </Alert>
      ) : (
        product && (
          <Box
          ...
          >
            <Stack direction={{ base: 'column', lg: 'row' }} align="flex-start">
              <Stack pr={{ base: '0', md: 'row' }} flex="1.5" mc={{ base: '12', md: 'none' }}>
                ...
                <Stack spacing="5">
                  ...
                  <Flex w="170px" border="1px" borderColor="gray.200" alignItems={'center'}>
                  ...
                  <Stack width='270px'>
                    ...
                    <Flex alignItems={'center'}>
                     ...
                     <Text fontWeight={'medium'} fontSize={'sm'} ml='2'>
                      2 year extended warrantty
                     </Text>
                    </Flex>
                    <Flex alignItems={'center'}><BiSupport size='20px'/>
              ...
              <Flex direction={'column'} align={'center'} flex='1' _dark={{bg: 'gray.900'}}>
                <Image mb='30px' src={product.images[0]} alt={product.name} fallback={'https://via.placeholder.com/259'}/>
                <Image mb='30px' src={product.images[1]} alt={product.name} fallback={'https://via.placeholder.com/259'}/>
              </Flex>
            </Stack>
            <Stack>
                ...
                {product.reviews.map((review) => (
                  <Box key={review.id}>
                    ...
                    <Text fontSize={'sm'} color='gray.400'>
                      by {review.name} on {new Date(review.createdAt).toDateString()}
                    </Text>
                  </Box>
                ))}
              </SimpleGrid>
